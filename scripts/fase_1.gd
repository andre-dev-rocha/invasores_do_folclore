...
func vitoria():
	estado_fase = "VITORIA"
	print("Fim da fase! Você venceu o Saci!")
	# Aqui você pode instanciar uma tela de Parabéns ou ir para o Menu
